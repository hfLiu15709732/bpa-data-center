  ...
  <div class="navbar">
    <div class="left-side">
      <a-space>
        ...
        <a-typography-title :style="{ margin: 0, fontSize: '19px', fontWeight: 700 }" :heading="5">
          新苗同学 数据中心
        </a-typography-title>
    ...
    <ul class="right-side">
      ...
      <li>
        ...
        <a-button :type="switchMode1" size="small" @click="changeMode(1)">综合数据分析</a-button>

      </li>
      <li>

        <a-button :type="switchMode2" size="small" @click="changeMode(2)">多维数据分析</a-button>
...
const switchMode1 = ref("primary");
const switchMode2 = ref("secondary");
